      ...
      <v-card>
        <v-table>
          ...
          <tbody>
            <tr>
              <td>
                <v-icon style="font-size: 2rem" class="tw-mx-6">
                  <svg
                    viewBox="0 0 24 24"
                    fill="none"
              ...
              <td class="tw-text-xl tw-text-[#082266]">1</td>
              <td class="tw-text-xl tw-text-[#082266]">
                This book is duplicated.
              </td>
              <td>
                <NuxtLink to="/">
              ...
              <td><v-btn color="#1D419F">Done</v-btn></td>
            </tr>
            ...
            <tr>
              ...
              <td class="tw-text-xl tw-text-[#082266]">1</td>
              <td class="tw-text-xl tw-text-[#082266]">This review is spam.</td>
              <td>
                <v-icon style="font-size: 2rem"
                  ><svg
                    viewBox="0 0 24 24"
            ...
            <tr>
              ...
              <td class="tw-text-xl tw-text-[#082266]">1</td>
              <td class="tw-text-xl tw-text-[#082266]">This user is spam.</td>
              <td>
                <v-icon style="font-size: 2rem"
                  ><svg
                    viewBox="0 0 24 24"
