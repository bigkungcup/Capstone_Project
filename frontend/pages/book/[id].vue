    ...
    <div class="tw-space-y-1">
        ...
        <div class="tw-flex tw-justify-center tw-h-3/5 tw-max-h-[30rem] tw-min-h-[30rem]">
            <v-card color="rgb(217, 217, 217, 0.6)" width="80%">
                ...
                <v-row no-gutters>
                    <v-col cols="4" class="tw-my-4 web-text-detail" align="center">
                        <v-img src="/image/cover_not_available.jpg" height="60%" width="100%"></v-img>
                        ...
                        <p class="web-text-rate">{{ book.data.bookRating }}</p></div>
