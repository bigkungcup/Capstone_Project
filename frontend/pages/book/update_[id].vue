...
await book.getBookDetail(route.params.id)
 book.newBook = {
    bookName: book.bookDetail.data.bookName,
    author: book.bookDetail.data.author,
    bookGenre: book.bookDetail.data.bookGenre,
    bookDetail: book.bookDetail.data.bookDetail,
  },
 book.newBookFile = book.bookDetail.data.file,
</script>
