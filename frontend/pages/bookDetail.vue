...
<template>
    ...
    <div class="tw-flex tw-justify-center tw-h-3/5 tw-max-h-[30rem] tw-min-h-[30rem]">
        <v-card color="#D9D9D9" theme="dark" width="80%">
            <v-row>
                ...
                <v-col cols="8" class="tw-my-4 tw-space-y-10">
                    <v-card-title class="text-h4 tw-text-[#082266]">
                        Book's Name
                    </v-card-title>

                    <v-card-subtitle class="text-h6 tw-text-[#1D419F]">
                        Author: Edogawa Conan
                    </v-card-subtitle>
                    <v-card-subtitle class="text-h6 tw-text-[#1D419F]">
                        Bookmarked by: 200 people
                    </v-card-subtitle>
                    <v-card-subtitle class="text-h6 tw-text-[#1D419F]">
                        Booktype:
                    </v-card-subtitle>
    ...
    <div class="tw-flex tw-justify-left my-2 tw-bg-[#D9D9D9] tw-min-h-[24rem]">
        <p class="tw-text-4xl tw-text-[#082266] tw-px-6 tw-py-2">Similar Book</p>
    </div>

    <div class="tw-flex tw-justify-center my-2 ">
        <div class="tw-bg-[#D9D9D9] tw-w-10/12 tw-min-h-[60rem] tw-rounded-lg">
            <p class="tw-text-3xl tw-text-[#082266] tw-px-6 tw-py-2"> Review (0): </p>
            <div class="tw-bg-white tw-flex tw-justify-center tw-m-5 tw-p-4 tw-min-h-[56rem] tw-rounded-lg">
                <v-container>
                    <v-row no-gutters>
                        <v-col cols="10">
                    ...
                    <v-row> <v-img src="/image/rvnotfound.png" width="50%"></v-img></v-row>
                </v-container>
