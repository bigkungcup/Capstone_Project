...
public class JwtAuthorizationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (request.getServletPath().equals("/api/auth/login") || request.getServletPath().equals("/api/auth/refresh")
                ...
                || request.getServletPath().equals("/api/book/ranking") || request.getServletPath().equals("/api/review/ratingCount") || request.getServletPath().equals("/api/user/forgetPassword") ) {
