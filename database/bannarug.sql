...
-- -----------------------------------------------------
-- Table `bannarug`.`Following`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bannarug`.`Following` ;

CREATE TABLE IF NOT EXISTS `bannarug`.`Following` (
  `followingId` INT NOT NULL AUTO_INCREMENT,
  `fu_userId` INT NOT NULL,
  `userFollowingId` INT NOT NULL,
  `followingStatus` INT NULL,
  `followingCreateDateTime` DATETIME NULL default current_timestamp,
  `followingUpdateDateTime` DATETIME NULL default current_timestamp on update current_timestamp,
  INDEX `fk_Follower_User1_idx` (`fu_userId` ASC) VISIBLE,
  INDEX `fk_Follower_User2_idx` (`userFollowingId` ASC) VISIBLE,
  PRIMARY KEY (`followingId`, `fu_userId`, `userFollowingId`),
